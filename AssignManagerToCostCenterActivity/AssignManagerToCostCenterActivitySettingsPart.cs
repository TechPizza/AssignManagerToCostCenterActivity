...
{
    public class AssignManagerToCostCenterActivitySettingsPart : ActivitySettingsPart
    {
        /// <summary>
        ...
        {
            AssignManagerToCostCenterActivity _calc = activity as AssignManagerToCostCenterActivity;
            if (null != _calc)
            {
        ...
        {
            get { return "Assign Manager To Cost Center Activity"; }
        }
